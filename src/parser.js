...
function dedrisIdFromName(a, b, c) {
	a = a.toLowerCase();
	if (0 === a.indexOf('ededris-' ) || 0 === a.indexOf('dedris-' )) {
		a = (a.split('-'))[1];
		var name = '';
		var num = '';
...
function removeFonts(doc) {
	...
	for (var t = 0; t < doc.text.length; t++) {
		var var0 = doc.text[t];
		if (typeof(var0.font) !== 'undefined') {
			var0.font = newId[var0.font];
		}
	}
	doc.fonts = newF;
	return doc;
...
function convert(doc) {
	for (var r = 0; r < doc.text.length; r++) {
		...
		if (typeof o.text !== 'undefined') {
			var f;
			if (typeof o.font !== 'undefined') {
				f = dedrisIdFromName(doc.fonts[o.font]);
			}
			if (f) {
...
if (typeof (module) !== 'undefined') {
	module.exports.toUnicode = convert; //node
} else {
	window.toUnicode = convert; // browser
}
